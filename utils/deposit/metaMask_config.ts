...
interface ConfigPropType {
 ...
 // 网络及代币种类配置
  // netId1 为选择的网络  每个网络所对应的代币及价格  =》不同的合约地址  
export default {
  deployments: {
    netId1: {
      eth: {
    ...
    netId5: {
      eth: {
        instanceAddress: {
          0.1: '0xE9Be2dDAD4f919d0fC107fBDC10Fd76F7ea48149',
          1: '0x19ea5076ab0796C19A88B5B5331B8Cf82Fe941a1',
          10: '0xFb7516f20B8a4709B42756703309a7dcBcE67341',
          100: '0xbDc79a97d1D6Df8B52e10Fc9cc2aD4A94928D39F',
        },
        symbol: 'ETH',
        decimals: 18,
      },
      ...
      usdt: {
        instanceAddress: {
          100: '0x417fD1693dD0F2176c55cDa469924E2e278a08Cf',
          1000: '0x33406F8dCADb122D636341453295229122Ef2013',
          10000: '0xE8985ED7D657F8Ca1BdeA6fd3F1b836Bf051D0d7',
          100000: '0x822121cA07e8953A96E53580E75d6d16eAA38469',
        },
        tokenAddress: '0xa32A62179043b55b858991f615EADeC1AfB8f6DC',
        symbol: 'USDT',
        decimals: 6,
      },
    },
    netId11155111: {
      eth: {
        instanceAddress: {
          0.1: '0x1087C3ec5CA2C0B5c768F864C525ac8feE4983b6',
          1: '0x29D489a7cbB7e199e540BDF62Ce8752B810708bC',
          10: '0x12c1121C4F1AAD46f1bee14b47A21A960C44d0d3',
          100: '0xA59D42c388d657Df0A6477F6316034BF2d1d97B7',
        },
        symbol: 'ETH',
        decimals: 18,
      },
      ...
      usdt: {
        instanceAddress: {
          100: '0xA559953d9c2837bc4b86E30f9a5fb817dDE19713',
          1000: '0x696961c0BCC32521ABF071F1dD0D5F06631Be6ce',
          10000: '0x0A33c218b7016d1807d45ff4Ed023dE5f6c3ed7d',
          100000: '0x3dBCD8b704Fc9163567A4C22b84920d749A38f32',
        },
        tokenAddress: '0xAE3372dc0E6ba9E3a0252f3b92A8dB4939e767de',
        symbol: 'USDT',
        decimals: 6,
      },
    },
...
//映射的ID名  必须与上面对应
export const networkIds: Record<string, string> = {
  "1": "Ethereum",
  "5": "Goerli",
  "11155111": "Sepolia",
}
